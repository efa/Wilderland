...
z80emu emulator based on Lin Ke-Fong free work github.com/anotherlin/z80emu
...
H ... Help - A short overview of commands, abbreviations and object properties
...
L ... Load - Loads a previous saved game WilderLandShapshot
      ...
      V10-mode (the same applies to V12 of course). Snapshot file from
...
G ... Go - Jump directly to a specific room. Enter number in hex and press
      ...
      a reference on room numbers. NB: this 'beaming' transports you and the
